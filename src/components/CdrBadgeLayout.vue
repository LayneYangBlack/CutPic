                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                for="edge-padding-h"
                                class="block text-sm font-medium text-gray-700"
                                >页面边缘留白-水平方向 (mm)</label
                            >
                            <input
                                type="number"
                                id="edge-padding-h"
                                v-model.number="edgePaddingH"
                                step="0.1"
                                class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-900"
                            />
                        </div>
                        <div>
                            <label
                                for="edge-padding-v"
                                class="block text-sm font-medium text-gray-700"
                                >页面边缘留白-垂直方向 (mm)</label
                            >
                            <input
                                type="number"
                                id="edge-padding-v"
                                v-model.number="edgePaddingV"
                                step="0.1"
                                class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-900"
                            />
                        </div>
...
const generateLayout = () => {
    ...
    const cols = Math.floor(
        (effectiveWidth + spacingHPx) / (outerDiaPx + spacingHPx),
    );
    const rows = Math.floor(
        (effectiveHeight + spacingVPx) / (outerDiaPx + spacingVPx),
    );
